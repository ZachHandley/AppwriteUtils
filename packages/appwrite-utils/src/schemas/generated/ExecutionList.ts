...
export const ExecutionListSchema = z.fromJSONSchema(ExecutionListJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ExecutionList = z.infer<typeof ExecutionListSchema>;
