...
const ProviderRepositoryRuntimeJsonSchema = {
...
export const ProviderRepositoryRuntimeSchema = z.fromJSONSchema(ProviderRepositoryRuntimeJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ProviderRepositoryRuntime = z.infer<typeof ProviderRepositoryRuntimeSchema>;
