...
export const AttributeLineSchema = z.fromJSONSchema(AttributeLineJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type AttributeLine = z.infer<typeof AttributeLineSchema>;
