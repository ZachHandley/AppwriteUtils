...
export const SpecificationListSchema = z.fromJSONSchema(SpecificationListJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type SpecificationList = z.infer<typeof SpecificationListSchema>;
