...
const AttributeBooleanJsonSchema = {
...
export const AttributeBooleanSchema = z.fromJSONSchema(AttributeBooleanJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
