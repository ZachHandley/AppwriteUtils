...
export const FunctionListSchema = z.fromJSONSchema(FunctionListJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type FunctionList = z.infer<typeof FunctionListSchema>;
