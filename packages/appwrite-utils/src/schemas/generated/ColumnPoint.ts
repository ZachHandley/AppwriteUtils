...
export const ColumnPointSchema = z.fromJSONSchema(ColumnPointJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ColumnPoint = z.infer<typeof ColumnPointSchema>;
