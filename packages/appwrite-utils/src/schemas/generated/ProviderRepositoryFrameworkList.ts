...
const ProviderRepositoryFrameworkListJsonSchema = {
...
export const ProviderRepositoryFrameworkListSchema = z.fromJSONSchema(ProviderRepositoryFrameworkListJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ProviderRepositoryFrameworkList = z.infer<typeof ProviderRepositoryFrameworkListSchema>;
