...
const AttributePointJsonSchema = {
...
export const AttributePointSchema = z.fromJSONSchema(AttributePointJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type AttributePoint = z.infer<typeof AttributePointSchema>;
