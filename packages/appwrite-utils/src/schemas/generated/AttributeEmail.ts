...
const AttributeEmailJsonSchema = {
...
export const AttributeEmailSchema = z.fromJSONSchema(AttributeEmailJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
