...
export const ColumnPolygonSchema = z.fromJSONSchema(ColumnPolygonJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ColumnPolygon = z.infer<typeof ColumnPolygonSchema>;
