...
export const UsageFunctionSchema = z.fromJSONSchema(UsageFunctionJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type UsageFunction = z.infer<typeof UsageFunctionSchema>;
