...
const AttributeStringJsonSchema = {
...
export const AttributeStringSchema = z.fromJSONSchema(AttributeStringJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
