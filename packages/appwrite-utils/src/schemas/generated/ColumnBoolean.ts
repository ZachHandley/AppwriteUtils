...
export const ColumnBooleanSchema = z.fromJSONSchema(ColumnBooleanJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ColumnBoolean = z.infer<typeof ColumnBooleanSchema>;
