...
const UsageFunctionsJsonSchema = {
...
export const UsageFunctionsSchema = z.fromJSONSchema(UsageFunctionsJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
