...
export const DevKeySchema = z.fromJSONSchema(DevKeyJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type DevKey = z.infer<typeof DevKeySchema>;
