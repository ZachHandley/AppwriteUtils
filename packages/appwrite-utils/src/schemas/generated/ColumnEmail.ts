...
export const ColumnEmailSchema = z.fromJSONSchema(ColumnEmailJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type ColumnEmail = z.infer<typeof ColumnEmailSchema>;
