...
const TemplateSiteListJsonSchema = {
...
export const TemplateSiteListSchema = z.fromJSONSchema(TemplateSiteListJsonSchema as unknown as Parameters<typeof z.fromJSONSchema>[0]);
export type TemplateSiteList = z.infer<typeof TemplateSiteListSchema>;
